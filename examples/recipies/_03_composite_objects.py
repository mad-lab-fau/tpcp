...
workflow_instance = Workflow(
    pipelines=[("pipe1", MyPipeline()), ("pipe2", MyPipeline(param2=5))]
)
# %%
...
workflow_instance = workflow_instance.set_params(
    pipelines__pipe1__param=2, pipelines__pipe2=MyPipeline(param2=4)
)
workflow_instance.get_params(deep=True)
